...
// Replace sr71-blackglider, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= sr71-blackglider — Quick Start for Users
:toc:
:toclevels: 2

== What is sr71-blackglider?
...
[source,bash]
----
just install --portable --prefix=./sr71-blackglider-portable
----
...
* **Wiki**: https://github.com/metadatastician/sr71-blackglider/wiki
