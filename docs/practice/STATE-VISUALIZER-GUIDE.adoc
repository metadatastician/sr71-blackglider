...
Jonathan D.A. Jewell (metadatastician) <j.d.a.jewell@open.ac.uk>
:toc:
:sectnums:
...
Use the template at TOPOLOGY.md in sr71-blackglider as a structural reference,
...
[source,bash]
----
cp /path/to/sr71-blackglider/TOPOLOGY.md ./TOPOLOGY.md
