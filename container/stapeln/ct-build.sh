...
#
# SR-71 BlackGlider — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: sr71-blackglider-release)
