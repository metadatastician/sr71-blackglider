...
# SR-71 BlackGlider container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping sr71-blackglider..."
...
echo "Starting sr71-blackglider..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/sr71-blackglider
#   exec /app/release/bin/sr71-blackglider start
#   exec /app/sr71-blackglider serve --host "${APP_HOST}" --port "${APP_PORT}"
