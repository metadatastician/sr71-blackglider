...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/sr71-blackglider/security/advisories/new)
...
- This repository (`metadatastician/sr71-blackglider`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/sr71-blackglider/security/advisories)
...
When using SR-71 BlackGlider, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/sr71-blackglider/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/sr71-blackglider/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/sr71-blackglider/discussions) |
...
*Thank you for helping keep SR-71 BlackGlider and its users safe.* 🛡️
