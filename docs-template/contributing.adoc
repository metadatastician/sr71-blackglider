...
= Contributing — SR-71 BlackGlider
:revdate: 2026-MM-DD

== Audience

Developers working *on* `SR-71 BlackGlider`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/SR-71 BlackGlider.git
cd SR-71 BlackGlider
...
* Bugs in `SR-71 BlackGlider`: file at `metadatastician/SR-71 BlackGlider/issues`.
